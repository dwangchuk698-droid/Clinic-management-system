...
<head runat="server">
    ...
    <style>
        ...
        body {
            ...
            background: radial-gradient(1000px 600px at 10% 10%, rgba(58,123,213,0.12), transparent 10%),
                        linear-gradient(135deg, #f6f9ff 0%, #eef6ff 100%);
            color: #1f2937;
        }
        ...
        #<%= lblMsg.ClientID %> {
            ...
            margin-bottom: 8px;
            font-size: 13px;
            color: #e11d48; /* red for errors; you can change on success in code-behind */
            min-height: 18px;
        }
...
<body>
    <form id="form1" runat="server">
        <div class="card">
            ...
            <span class="muted">Sign in to your clinic account</span>
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; margin-top:12px;">
                <asp:HyperLink ID="hlRegister" runat="server" NavigateUrl="Register.aspx" CssClass="small-link">Register new account</asp:HyperLink>
                <!-- optional "forgot" link -->
                <asp:HyperLink ID="hlForgot" runat="server" NavigateUrl="ForgotPassword.aspx" CssClass="small-link" style="margin-left:auto;">Forgot?</asp:HyperLink>
            </div>
        </div>
    </form>
</body>
