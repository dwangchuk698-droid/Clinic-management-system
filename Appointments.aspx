<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Appointments.aspx.cs" Inherits="Hospital.Appointments" %>
...
<asp:Content ID="Content6" runat="server" contentplaceholderid="ContentPlaceHolder2">
    <body>
               ...
               <style>
        .container { width: 90%; margin: 30px auto; background:#fff; padding:20px; border-radius:8px; box-shadow:0 0 8px rgba(0,0,0,0.08); }
        h2 { text-align:center; color:#333; margin-bottom:18px; }
        .grid { width:100%; border-collapse:collapse; }
        .grid th, .grid td { border:1px solid #e0e0e0; padding:8px 10px; text-align:left; }
    ...
    <div id="form1" runat="server">
        <!-- assume header included by master page if used -->
        <div class="container">
            <h2>Appointment Management</h2>

            <asp:GridView ID="gvAppointments" runat="server" CssClass="grid" AutoGenerateColumns="False"
                DataKeyNames="AppointmentID" OnRowCommand="gvAppointments_RowCommand" EmptyDataText="No appointments found.">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:Button ID="btnApprove" runat="server" Text="Approve" CommandName="Approve"
                                CommandArgument='<%# Eval("AppointmentID") %>' CssClass="btn btn-approve" />
                            <asp:Button ID="btnReject" runat="server" Text="Reject" CommandName="Reject"
                                CommandArgument='<%# Eval("AppointmentID") %>' CssClass="btn btn-reject" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
        </div>
        <!-- assume footer included by master page if used -->
    </div>
</asp:Content>
