<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Timeline.aspx.cs" Inherits="Hospital.Timeline" %>
...
<asp:Content ID="Content6" runat="server" contentplaceholderid="ContentPlaceHolder2">
    ...
    <div id="form1" runat="server">
        <div class="container">
            <h2>Our Journey</h2>
            <asp:Label ID="lblDebug" runat="server" CssClass="debug"></asp:Label>
            ...
            <div class="timeline">
                <asp:Repeater ID="rptTimeline" runat="server">
                    <ItemTemplate>
                        <div class="event">
                            <h3><%# Eval("Title") %></h3>
                            <span><%# Eval("EventDate", "{0:MMMM dd, yyyy}") %></span>
